...
class posts_controller extends base_controller {
    ...
    public function index() {
        ...
        # Build the query for viewing user's posts you are following
         $q= 'SELECT 
                posts.post_id,      
                posts.content,
                posts.created,
        ...
        #query for liking posts
        $q = 'SELECT
                like_posts.post_id_liked
            FROM like_posts
            INNER JOIN posts
                ON posts.post_id = like_posts.post_id_liked
            WHERE like_posts.user_id= '.$this->user->user_id;


        #run the query
        $like = DB::instance(DB_NAME)->select_array($q, 'post_id_liked');
    ...
    public function like($post_id_liked) {
        ...
        #Do the insert
        DB::instance(DB_NAME)->insert('like_posts', $data);  
